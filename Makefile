...
test:
	...
	env WIT_TOKEN=test-wit-token FB_PAGE_TOKEN=test-page-token FB_VERIFY_TOKEN=test-verify-token FB_APP_SECRET=test-app-secret OPEN_WEATHER_TOKEN=test-weather-token $(PYTHON) -m unittest test_messenger
